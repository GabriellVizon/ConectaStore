...
using (var scope = app.Services.CreateScope())
{
    ...
    // Seed novas categorias e produtos em banco já existente
    if (!await db.Categorias.AnyAsync(c => c.Nome == "Tablets"))
{
    db.Categorias.AddRange(
        new ConectaStore.API.Models.Categoria
        {
            Nome = "Tablets",
            Cor = "#A855F7"
        },
...
var tablets = await db.Categorias
    .FirstAsync(c => c.Nome == "Tablets");

var acessorios = await db.Categorias
    .FirstAsync(c => c.Nome == "Acessórios");

var gaming = await db.Categorias
    .FirstAsync(c => c.Nome == "Gaming");

var audio = await db.Categorias
    .FirstAsync(c => c.Nome == "Áudio");

    if (!await db.Produtos.AnyAsync(p => p.Nome == "Samsung Galaxy Tab S9"))
    {
        db.Produtos.AddRange(
            new ConectaStore.API.Models.Produto { Id = 5, CategoriaId = 5, Nome = "Samsung Galaxy Tab S9", Descricao = "Tablet premium com tela Dynamic AMOLED 2X de 11 polegadas, processador Snapdragon 8 Gen 2, caneta S-PEN inclusa, resistência à água IP68.", ValorCusto = 1800m, ValorVenda = 8500.00m, Qtde = 6, Destaque = true, Foto = "https://images.samsung.com/is/image/samsung/p6p-br/galaxy-tab-s9/bu_tab_s9_lunar_silver.jpg" },
            new ConectaStore.API.Models.Produto { Id = 6, CategoriaId = 5, Nome = "iPad Air M2", Descricao = "iPad Air com chip M2, tela Liquid Retina de 11 polegadas, compatível com Apple Pencil e Magic Keyboard. Ideal para produtividade e criatividade.", ValorCusto = 2200m, ValorVenda = 9200.00m, Qtde = 4, Destaque = false, Foto = "https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/ipad-air-m2-select?wid=940&hei=1112&fmt=png-alpha&.v=1700792800" },
            new ConectaStore.API.Models.Produto { Id = 7, CategoriaId = 6, Nome = "Carregador Turbo 65W", Descricao = "Carregador USB-C PD 65W compacto, compatível com notebooks e smartphones. Carregamento rápido GaN, proteção contra sobrecarga.", ValorCusto = 45m, ValorVenda = 189.90m, Qtde = 25, Destaque = false, Foto = "https://m.media-amazon.com/images/I/51L3tG7tJTL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 8, CategoriaId = 6, Nome = "Capa para Notebook 15\"", Descricao = "Capa protetora universal para notebooks de até 15.6 polegadas. Material resistente a impactos, interior acolchoado, alça de transporte.", ValorCusto = 35m, ValorVenda = 149.90m, Qtde = 18, Destaque = false, Foto = "https://m.media-amazon.com/images/I/71b8J1fVqOL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 9, CategoriaId = 7, Nome = "Mouse Gamer RGB", Descricao = "Mouse gamer com sensor óptico de 16000 DPI, 8 botões programáveis, iluminação RGB personalizável, cabo trançado USB.", ValorCusto = 60m, ValorVenda = 249.90m, Qtde = 15, Destaque = true, Foto = "https://m.media-amazon.com/images/I/61Hn4TCjtDL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 10, CategoriaId = 7, Nome = "Teclado Mecânico Gamer", Descricao = "Teclado mecânico RGB com switches azuis, estrutura em alumínio, teclas PBT double-shot, anti-ghosting, USB-C destacável.", ValorCusto = 110m, ValorVenda = 449.90m, Qtde = 10, Destaque = false, Foto = "https://m.media-amazon.com/images/I/71b8J1fVqOL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 11, CategoriaId = 7, Nome = "Headset Gamer 7.1", Descricao = "Headset gamer com som surround 7.1 virtual, drivers de 50mm, microfone com cancelamento de ruído, almofadas em couro respirável.", ValorCusto = 90m, ValorVenda = 379.90m, Qtde = 7, Destaque = true, Foto = "https://m.media-amazon.com/images/I/61CGHv6kmWL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 12, CategoriaId = 8, Nome = "Caixa de Som Bluetooth", Descricao = "Caixa de som portátil Bluetooth 5.3, 30W RMS, graves potentes, resistência à água IPX7, bateria de 12 horas.", ValorCusto = 80m, ValorVenda = 329.90m, Qtde = 14, Destaque = true, Foto = "https://m.media-amazon.com/images/I/71b8J1fVqOL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 13, CategoriaId = 8, Nome = "Soundbar 2.1", Descricao = "Soundbar 2.1 canais com subwoofer wireless, 200W RMS, Bluetooth 5.0, entradas HDMI ARC e óptica, controle remoto incluso.", ValorCusto = 200m, ValorVenda = 899.90m, Qtde = 5, Destaque = false, Foto = "https://m.media-amazon.com/images/I/61CGHv6kmWL._AC_SX679_.jpg" },
            new ConectaStore.API.Models.Produto { Id = 14, CategoriaId = 1, Nome = "Galaxy S24 Ultra", Descricao = "Smartphone premium Samsung com tela Dynamic AMOLED 2X de 6.8 polegadas, processador Snapdragon 8 Gen 3, câmera de 200MP, S-PEN integrada.", ValorCusto = 2500m, ValorVenda = 11000.00m, Qtde = 7, Destaque = true, Foto = "https://images.samsung.com/is/image/samsung/p6p-br/galaxy-s24-ultra/bu_s24_ultra_titanium_gray.jpg" },
            new ConectaStore.API.Models.Produto { Id = 15, CategoriaId = 2, Nome = "Galaxy Book4 Pro", Descricao = "Notebook premium Samsung com tela AMOLED 3K de 16 polegadas, processador Intel Core Ultra 7, 16GB RAM, SSD 512GB.", ValorCusto = 3000m, ValorVenda = 15000.00m, Qtde = 2, Destaque = true, Foto = "https://images.samsung.com/is/image/samsung/p6p-br/galaxy-book4-pro/bu_book4_pro_platinum_silver.jpg" },
            new ConectaStore.API.Models.Produto { Id = 16, CategoriaId = 4, Nome = "Galaxy Buds3 Pro", Descricao = "Fones de ouvido True Wireless com cancelamento ativo de ruído adaptativo, som 24-bit Hi-Fi, bateria de 6h + 18h estojo.", ValorCusto = 500m, ValorVenda = 2200.00m, Qtde = 10, Destaque = false, Foto = "https://images.samsung.com/is/image/samsung/p6p-br/galaxy-buds3-pro/bu_buds3_pro_silver.jpg" }
        );
        await db.SaveChangesAsync();
    }
}
