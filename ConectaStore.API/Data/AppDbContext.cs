...
public class AppDbContext : DbContext
{
    ...
    private static void SeedProduto(ModelBuilder builder)
    {
        List<Produto> produtos = [
            ...
            new() { Id = 12, CategoriaId = 8, Nome = "Caixa de Som Bluetooth", Descricao = "Caixa de som portátil Bluetooth 5.3, 30W RMS, graves potentes, resistência à água IPX7, bateria de 12 horas.", ValorCusto = 80m, ValorVenda = 329.90m, Qtde = 14, Destaque = true, Foto = "https://m.media-amazon.com/images/I/71HdLDJEEUL._AC_SX679_.jpg" },
            new() { Id = 13, CategoriaId = 8, Nome = "Soundbar 2.1", Descricao = "Soundbar 2.1 canais com subwoofer wireless, 200W RMS, Bluetooth 5.0, entradas HDMI ARC e óptica, controle remoto incluso.", ValorCusto = 200m, ValorVenda = 899.90m, Qtde = 5, Destaque = false, Foto = "https://m.media-amazon.com/images/I/51YmunJoecL._AC_SX679_.jpg" },
